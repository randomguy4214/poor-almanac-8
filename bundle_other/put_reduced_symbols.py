...
latest_dates = latest_dates[(latest_dates['date_diff'] > 70) & (latest_dates['date_diff'] < 390)]
# financials update once per quarter, ie ca 90 days. to be on a safe side, we take a little less days to check
