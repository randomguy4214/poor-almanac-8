#!/usr/bin/python
print('process_financials_a_incr - initiating..')
import os
import sys
import pandas as pd
...
financials_table_old = pd.read_csv(os.path.join(cwd,input_folder,'3_processed_financials_a.csv'), low_memory=False)
...
# export
df_financials_all.to_csv(os.path.join(cwd,input_folder,"3_processed_financials_a.csv"), index=False)
...
print('financials_a_incr - processed')