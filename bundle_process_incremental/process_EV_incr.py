#!/usr/bin/python
print('process_EV_incr - initiating.')
import os
import pandas as pd
...
for s in reduced_symbols['symbol']:
    ...
    for path in paths:
        ...
        path_to_folder_only = os.path.join(cwd,input_folder,temp_folder,EV)
...
# load old table
table_old = pd.read_csv(os.path.join(cwd,input_folder,"3_processed_EV_q.csv"),low_memory=False)
