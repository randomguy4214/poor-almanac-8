...
cocoa_coffee = commodities_df.iloc[:,[10,11,12, 47]]
tea = commodities_df.iloc[:,[13,14,15,16]]
oils = commodities_df.iloc[:,[17,21,22,24]]
beans = commodities_df.iloc[:,[18,23,25,27]]
plants = commodities_df.iloc[:,[19,20,26,28,29,30]]
rice = commodities_df.iloc[:,[31,32,33,34]]
wheat = commodities_df.iloc[:,[35,36]]
fruits = commodities_df.iloc[:,[37,38,39]]
meat = commodities_df.iloc[:,[40,41,42,43]]
sugar = commodities_df.iloc[:,[44,45,46]]
wood = commodities_df.iloc[:,[48,49,50,51,52]]
materials_one = commodities_df.iloc[:,[53,54,55]]
fertilizers = commodities_df.iloc[:,[56,57,58,59,60]]
metals = commodities_df.iloc[:,[61,62,63,64,65,66,67,68,69,70]]
